package ud4.examples.jssecinema.client;

import ud4.examples.Config;
import ud4.examples.jssecinema.models.Film;
import ud4.examples.jssecinema.models.Request;
import ud4.examples.jssecinema.models.RequestType;
...
public class CinemaClient {
    ...
    public CinemaClient(String host, int port) throws IOException {
        ...
        this.config = Config.getConfig("application.properties");
