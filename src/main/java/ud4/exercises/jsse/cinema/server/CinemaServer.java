package ud4.exercises.jsse.cinema.server;
...
public class CinemaServer {
    ...
    public CinemaServer(int port) throws IOException {
        ...
        System.setProperty("javax.net.ssl.keyStore", config.getProperty("ud4.exercises.cinema.keystore.path"));
        System.setProperty("javax.net.ssl.keyStorePassword", config.getProperty("ud4.exercises.cinema.keystore.password"));
