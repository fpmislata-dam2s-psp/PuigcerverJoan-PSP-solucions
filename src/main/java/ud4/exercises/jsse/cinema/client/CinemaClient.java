package ud4.exercises.jsse.cinema.client;

import ud4.exercises.jsse.cinema.models.Film;
import ud4.exercises.jsse.cinema.models.Request;
import ud4.exercises.jsse.cinema.models.RequestType;
...
public class CinemaClient {
    ...
    public CinemaClient(String host, int port) throws IOException {
        ...
        System.setProperty("javax.net.ssl.trustStore", config.getProperty("ud4.exercises.cinema.truststore.path"));
        System.setProperty("javax.net.ssl.trustStorePassword", config.getProperty("ud4.exercises.cinema.truststore.password"));
